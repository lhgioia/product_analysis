...
pairs3 <- c("LANEIGE Water Bank Blue Hyaluronic Intensive Moisturizer", "innisfree Green Tea Seed Hyaluronic Cream")
pairs4 <- c("Olay Super Cream with Sunscreen", "Olay Complete UV365 Daily Moisturizer with Sunscreen")

ingredientComparison <- data.frame(ingredientListsClean[[pairs1[1]]],
                                   c(ingredientListsClean[[pairs1[2]]],
                                       rep("-", (length(ingredientListsClean[[pairs1[1]]]) - 
                                             length(ingredientListsClean[[pairs1[2]]])))))

names(ingredientComparison) <- pairs1
...
tableLength <- length(ingredientListsClean[[pairs1[1]]])

testDataTable <- datatable(ingredientMatches, options = list(
