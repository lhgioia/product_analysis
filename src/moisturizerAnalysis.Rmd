...
ingredientCountsPerProductSorted$product <- factor(ingredientCountsPerProductSorted$product,
                                                      levels = ingredientCountsPerProductSorted$product)

ggplot(ingredientCountsPerProductSorted, aes(product, count)) +
  geom_bar(stat="identity") +
  labs(title = "Number of Ingredients in Each Product",
       x = "",
       y = "Counts") +
