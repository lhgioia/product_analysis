...
ingSharedBy12 <- prodDf[,which(colSums(prodDf) > 11)]

ingCor <-cor(ingSharedBy12, method = "spearman")
corrplot(ingCor, type="upper", order="hclust",
...
prodCor <-cor(ingSharedBy2, method = "spearman")
corrplot(prodCor, type="upper", order="hclust",
         col=brewer.pal(n=8, name="RdYlBu"))
```
\
