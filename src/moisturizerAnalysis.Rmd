...
```{r}
cor.test(ingCountsPrice$count, ingCountsPrice$priceperoz)
```

There's is a statistically significant correlation between price and ingredient count. I guess that makes sense. Let's visualize the correlation using the [plotly package](https://plotly.com/r/) to give a nice hover effect.
